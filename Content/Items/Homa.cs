...
namespace BooTao2.Content.Items
{
	public class Homa : ModItem
	{
		...
		//{
			// DisplayName.SetDefault("Homa"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
		//	Tooltip.SetDefault("was never a staff\n[c/FF9696:This text is red.]");
