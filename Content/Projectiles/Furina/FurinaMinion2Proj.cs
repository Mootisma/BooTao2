...
{
	public class FurinaMinion2Proj : ModProjectile
	{
		...
		public override void AI() {
			...
			if (foundTarget && (counter >= 200) && (Main.myPlayer == Projectile.owner)) {
				counter = 0;
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, vel, ModContent.ProjectileType<FurinaBubble2Proj>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0, 1);
			}
			else {
				counter++;
			}
