...
{
	public class SuiseiChannelProj : ModProjectile
	{
		...
		public override void SetDefaults() {
			Projectile.width = 50; // The width of the projectile's hitbox.
			Projectile.height = 50; // The height of the projectile's hitbox.
