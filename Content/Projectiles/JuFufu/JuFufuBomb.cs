...
namespace BooTao2.Content.Projectiles.JuFufu
{
	...
	public class JuFufuBomb : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center + new Vector2(0, -65), Vector2.Zero, ModContent.ProjectileType<QingqueExplosionProj>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
		}
		...
		public override void AI() {
			...
			Projectile.velocity = Projectile.velocity.ToRotation().AngleTowards(targetAngle, MathHelper.ToRadians(10)).ToRotationVector2() * projSpeed;
