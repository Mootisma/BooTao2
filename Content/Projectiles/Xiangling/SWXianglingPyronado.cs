...
{
	public class SWXianglingPyronado : ModProjectile
	{
		public override string Texture => "BooTao2/Content/Projectiles/Xiangling/XianglingPyronado";
		public ref float Distance => ref Projectile.ai[0];
		public ref float Position => ref Projectile.ai[1];
		int deg = 0;
		...
		public sealed override void SetDefaults() {
			...
			Projectile.minionSlots = 0f; // Amount of slots
		...
		public override void AI() {
			...
			*/
            ...
            float dist = Distance; //Distance away from the player
