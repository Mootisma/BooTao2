    ...
    public class NingJade2 : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (player.GetModPlayer<BooTaoPlayer>().NingJade2State || damageState) {
				...
				{
					Projectile.position.X = player.Center.X - 40;
				}
				else
				{
				...
				Projectile.position.Y = ownerMountedCenter.Y - Projectile.height / 2 - 7;
				UpdateMovement();
			}
        }
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			...
			player.GetModPlayer<BooTaoPlayer>().NingJade2State = false;
			damageState = false;
		}
